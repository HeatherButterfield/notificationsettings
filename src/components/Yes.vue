<template>
  <v-app style="padding: 30px; background: white;">
    <div class="d-flex text-left flex-column align-center justify-center" v-if="!submit">
      ...
      <h3 style="width: 315px;" class="margin-b margin-t">Is there anything else you'd like to be notified about in the future?</h3>
      <v-select
        v-model="selected"
        style="width: 315px"
        :items="notify"
